...
import org.ksug.RestfulWebserviceApplication;
import org.ksug.board.Post;
import org.ksug.board.module.BoardNotFoundException;
import org.ksug.board.module.BoardService;
import org.ksug.board.module.PostForm;
import org.ksug.board.module.PostNotFoundException;
...
@SpringApplicationConfiguration(classes = RestfulWebserviceApplication.class)
...
public class BoardControllerTest {
	...
	public void 게시물_쓰기_요청() {
		...
		MatcherAssertionErrors.assertThat(resposne.getStatusCode(), Matchers.is(HttpStatus.CREATED));
